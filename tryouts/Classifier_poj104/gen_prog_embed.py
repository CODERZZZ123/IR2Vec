...
LLVM_OUTPUT_BASE_DIR = "/home/es21btech11028/Classifier_poj104/data"

# Base directory where the program embeddings will be saved
PROGRAM_EMBEDDINGS_BASE_DIR = "program_embeddings"

# Create the base directory for embeddings if it doesn't exist
os.makedirs(PROGRAM_EMBEDDINGS_BASE_DIR, exist_ok=True)
...
for root, dirs, files in os.walk(LLVM_OUTPUT_BASE_DIR):
    for file in files:
        if file.endswith(".ll"):
            ...
            embedding_output_dir = os.path.join(PROGRAM_EMBEDDINGS_BASE_DIR, relative_path)
            ...
            try:
                ...
                np.save(embedding_file_path, progVector)
